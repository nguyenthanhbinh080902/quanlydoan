    ...
    <div class="menu border-bottom">
      ...
      >
        <div class="container-fluid" style="height: 100%">
          <!-- logo -->
          <a class="navbar-brand" style="height: 100%" href="index.html">
            <img
              style="height: 100%"
          ...
          <div class="collapse navbar-collapse" id="mynavbar">
            <ul class="navbar-nav m-auto">
              <li class="nav-item">
                <a class="nav-link text-hover active-now" href="index.html">
                  <i class="fa-solid fa-house"></i>
                  Trang chủ
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-hover" href="collections.html">
                ...
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li>
                      <a
                        class="dropdown-item text-hover"
                        href="category/fried-foods.html"
                        >Đồ chiên</a
                      >
                    </li>
                    <li>
                ...
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li>
                      <a
                        class="dropdown-item text-hover"
                        href="category/soft-drinks.html"
                        >Nước ngọt</a
                      >
                    </li>
                    <li>
